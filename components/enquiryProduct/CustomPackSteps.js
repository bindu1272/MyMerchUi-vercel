    ...
    return (
        ...
        >
            <div>
                ...
                <h1 className="title">Get personal with custom pack</h1>
                <p>
                    Whether you’re building your team or community, launching a campaign
                    or boosting customer engagement,{" "}
                    <span>personalised custom packs</span> will get you there. And with
...
export default CustomPackSteps;