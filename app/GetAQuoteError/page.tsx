...
import ContactUsSubmitError from "@/components/contactus/ContactUsSubmitError";
...
const ContactUsErrorPage = ({ headerBanners }:any) => {
    ...
    <>
      ...
      <div className="container">
        <div className="row mt-5 mb-5">
          <div className="col-sm-12">
            <GoogleSetup
              title={"Contact Us | Get a Quote Error"}
              description={""}
            />
            <ContactUsSubmitError />
          </div>
        </div>
      </div>
    </>
...
export default connect(mapStateToProps, {})(ContactUsErrorPage);
