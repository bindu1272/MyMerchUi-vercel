...
const MyMerchInspoDetails = ({params}:any) => {
  ...
  const onPreviousButtonClick = () => {
    ...
    history.push(`/my-merch-inspo-details/${previousInspo.slug}`);
  };

  const onNextButtonClick = () => {
    const nextInspo:any = inspos[currentInspoIndex + 1];
    history.push(`/my-merch-inspo-details/${nextInspo.slug}`);
  };
  ...
  const handleInspoCategoryChange = (value:any) => {
    history.push(`/my-merch-inspo/${value}`);
  };
  return loading ? (
    <Spin />
  ) : (
          ...
          <div className="row">
            <div className="col-sm-7">
              <div className="bread_crumb_nav">
                ...
                <Link href="/my-merch-inspo">MyMerch Inspo</Link>
                <span className="arrow">
                  <RightOutlined />
                </span>
                <Link href={`/my-merch-inspo-details/${currentInspo.slug}`}>
                  {currentInspo.title}
                </Link>
              </div>
            </div>
            <div className="col-sm-5">
              ...
              >
                ...
                <div className="bc-links">
                  <Link href="/my-merch-inspo/all">​View All</Link>
                  {inspoCategories &&
